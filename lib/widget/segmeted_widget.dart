...
// vertex of the CupertinoSegmented's Rect.
//
...
class _Segment<T> extends StatefulWidget {
  ...
  // Whether the thumb of the parent widget (CupertinoSegmented)
...
///
/// {@tool dartpad}
/// This example shows a [CupertinoSegmented] with an enum type.
///
...
class CupertinoSegmented<T> extends StatefulWidget {
  ...
  @override
  State<CupertinoSegmented<T>> createState() => _SegmentedControlState<T>();
}

class _SegmentedControlState<T> extends State<CupertinoSegmented<T>>
    with TickerProviderStateMixin<CupertinoSegmented<T>> {
  ...
  @override
  void didUpdateWidget(CupertinoSegmented<T> oldWidget) {
    super.didUpdateWidget(oldWidget);
